...
{
	CString request_method;  // 代表请求的方法，如GET、POST
	...
	CString request_referer; // 代表请求的Referer
	...
	CString request_modified_date;  // 代表请求的If-Modified-Since
	CString request_match;         // 代表请求的If-None-Match
	CString request_user_agent;  // 代表请求的User-Agent
	CString request_host;      // 代表请求的Host
	CString request_connection;// 代表请求的Connection，如 Keep-Alive
	CString request_cookie;    // 代表请求的Cookie
